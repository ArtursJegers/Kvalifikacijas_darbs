				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width:440px; height:250px;'/>
								</div>
...
if (isset($_POST["count_item"])) {
	...
	if (isset($_SESSION["uid"])) {
		...
		//When user is not logged in then we will count number of item in cart by using users ip
...
if (isset($_POST["Common"])) {
	...
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
			...
			?>
				<a style="float:right;" href="cart.php" class="btn btn-success">Cart&nbsp;&nbsp;<span class="glyphicon glyphicon-edit"></span></a>
			<?php
			exit();
		}
	}
